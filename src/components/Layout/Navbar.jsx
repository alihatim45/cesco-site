    ...
    >
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative">
        <div className="relative flex items-center h-[var(--navbar-height)]">
          ...
          <div className="hidden lg:flex items-center gap-1 absolute left-1/2 -translate-x-1/2 rounded-full border border-green-primary/10 bg-white/70 p-1 shadow-sm">
            {navLinks.map((link) =>
              link.isCta ? (
                <Link
                  key={link.path}
        ...
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="mobile-menu absolute inset-x-0 top-full lg:hidden mx-3 mt-2 py-3 rounded-2xl border border-white/70 bg-white/95 shadow-xl backdrop-blur-xl z-50"
          >
